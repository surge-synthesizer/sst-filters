...
TEST_CASE("Tri-pole Filter")
{
    ...
    SECTION("First Stage")
    {
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::First_output, sfpp::Passband::LowLowLow}, 0, 0.5,
                {-4.25326f, -6.37334f, -13.6173f, -17.6295f, -20.9406f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::First_output, sfpp::Passband::LowHighLow}, 0, 0.5,
                {-8.15925f, -8.96029f, -10.9976f, -17.4781f, -20.1552f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::First_output, sfpp::Passband::HighLowHigh}, 0, 0.5,
                {-17.3739f, -8.23246f, -3.939f, -2.9143f, -3.07959f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::First_output, sfpp::Passband::HighHighHigh}, 0, 0.5,
                {-15.6124f, -6.58177f, -4.77551f, -3.50092f, -3.09306f});
    }
    ...
    SECTION("Second Stage")
    {
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Second_output, sfpp::Passband::LowLowLow}, 0, 0.5,
                {-8.39167f, -12.4356f, -19.2612f, -21.1454f, -22.5948f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Second_output, sfpp::Passband::LowHighLow}, 0, 0.5,
                {-22.0593f, -14.0584f, -12.8537f, -18.3194f, -22.1564f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Second_output, sfpp::Passband::HighLowHigh}, 0, 0.5,
                {-17.5901f, -12.9352f, -15.7992f, -21.2519f, -38.8294f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Second_output, sfpp::Passband::HighHighHigh}, 0, 0.5,
                {-29.9571f, -11.3739f, -5.64681f, -3.70194f, -3.17114f});
    }
    ...
    SECTION("Third Stage")
    {
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Third_output, sfpp::Passband::LowLowLow}, 0, 0.5,
                {-18.5412f, -19.5961f, -22.0208f, -19.3382f, -18.5305f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Third_output, sfpp::Passband::LowHighLow}, 0, 0.5,
                {-17.9264f, -19.5055f, -22.491f, -27.3633f, -23.4616f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Third_output, sfpp::Passband::HighLowHigh}, 0, 0.5,
                {-28.0098f, -22.5628f, -19.7113f, -18.2213f, -18.279f});
        ...
        runTest(sfpp::FilterModel::TriPole,
                {sfpp::FilterSubModel::Third_output, sfpp::Passband::HighHighHigh}, 0, 0.5,
                {-30.506f, -22.8295f, -19.6699f, -18.9364f, -22.5596f});
    }
}
