/*
 * This exists since if we put it in FilterConfiguration then we suck in a
 * fmt:: dependency
 */

#ifndef SSTFILTERS_FILTERCONFIGURATIONLABELS_H
#define SSTFILTERS_FILTERCONFIGURATIONLABELS_H
