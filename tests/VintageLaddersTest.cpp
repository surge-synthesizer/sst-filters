...
TEST_CASE("Vintage Ladders")
{
    ...
    SECTION("Vintage Ladder RK")
    {
        ...
        runTest(sfpp::FilterModels::VintageLadder,
                {sfpp::PassTypes::LP, sfpp::SubModelTypes::RungeKutta}, 0, 0.5,
                {-17.9486f, -16.0861f, -13.4772f, -37.4639f, -64.0226f});
        ...
        runTest(sfpp::FilterModels::VintageLadder,
                {sfpp::PassTypes::LP, sfpp::SubModelTypes::RungeKuttaCompensated}, 0, 0.5,
                {-10.7992f, -8.91631f, -8.36544f, -30.9535f, -57.8073f});
    }
    ...
    SECTION("Vintage Ladder Huov")
    {
        ...
        runTest(sfpp::FilterModels::VintageLadder, {sfpp::PassTypes::LP, sfpp::SubModelTypes::Huov},
        ...
        runTest(sfpp::FilterModels::VintageLadder,
                {sfpp::PassTypes::LP, sfpp::SubModelTypes::HuovCompensated}, 0, 0.5,
                {-6.17262f, -4.30116f, -3.1663f, -26.5073f, -53.0447f});
    }
}
